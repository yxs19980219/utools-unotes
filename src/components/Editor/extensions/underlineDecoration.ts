...
function buildUnderlineDecorations(view: EditorView): DecorationSet {
  ...
  while ((m = UNDERLINE_RE.exec(text)) !== null) {
    ...
    if (lines.has(doc.lineAt(from).number)) continue
